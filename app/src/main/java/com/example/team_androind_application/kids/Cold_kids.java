...
public class Cold_kids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cold_kids);
        ...
        profilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Cold_kids.this, ProfileActivity.class);
        ...
        listbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Cold_kids.this, ListActivity.class);
                startActivity(intent);
        ...
        basketbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Cold_kids.this, BasketActivity.class);
                startActivity(intent);
        ...
        mainbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Cold_kids.this, MainActivity.class);
                startActivity(intent);
        ...
        mainbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Cold_kids.this, Ibuprof_adult.class);
                startActivity(intent);
